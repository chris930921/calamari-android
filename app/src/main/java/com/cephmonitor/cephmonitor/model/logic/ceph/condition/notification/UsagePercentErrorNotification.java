 ...
 */
public class UsagePercentErrorNotification extends ConditionNotification<ClusterV1HealthCounterData> {
    ...
    public Notification onTrue(Context context, ClusterV1HealthCounterData data) {
        String title = context.getResources().getString(R.string.check_service_usage_percent_error_title);
        String content =context.getResources().getString(R.string.check_service_usage_percent_error_content);
