 ...
 */
public class UsagePercentWranNotification extends ConditionNotification<ClusterV1HealthCounterData> {

    public UsagePercentWranNotification(Context context) {
        super(context);
    }
    ...
    public Notification onTrue(Context context,ClusterV1HealthCounterData data) {
        try {
            String title = context.getResources().getString(R.string.check_service_usage_percent_warn_title);
            String content = String.format(
                    context.getResources().getString(R.string.check_service_usage_percent_warn_content),
