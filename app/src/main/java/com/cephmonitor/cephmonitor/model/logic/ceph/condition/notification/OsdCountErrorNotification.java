...
public class OsdCountErrorNotification extends ConditionNotification<ClusterV1HealthCounterData> {
    ...
    public Notification onTrue(Context context,ClusterV1HealthCounterData data) {
        try {
            String title = context.getResources().getString(R.string.check_service_osd_count_error_title);
            String content = String.format(
                    context.getResources().getString(R.string.check_service_osd_count_error_content),
