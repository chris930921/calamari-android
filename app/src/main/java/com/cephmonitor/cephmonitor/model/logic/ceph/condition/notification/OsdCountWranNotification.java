 ...
 */
public class OsdCountWranNotification extends ConditionNotification<ClusterV1HealthCounterData> {

    public OsdCountWranNotification(Context context) {
        super(context);
    }
    ...
    public Notification onTrue(Context context,ClusterV1HealthCounterData data) {
        try {
            String title = context.getResources().getString(R.string.check_service_osd_count_warn_title);
            String content = String.format(
                    context.getResources().getString(R.string.check_service_osd_count_warn_content),
