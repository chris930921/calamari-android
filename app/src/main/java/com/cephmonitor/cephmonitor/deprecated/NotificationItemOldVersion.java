...
public class NotificationItemOldVersion extends RelativeLayout {
    ...
    public NotificationItemOldVersion(Context context) {
        super(context);
        ...
        public void onClick(MotionEvent event) {
            if (event.getX() > getMeasuredWidth() - ruler.getW(10)) {
                if (rightImageClickEvent != null) {
                    rightImageClickEvent.onClick(NotificationItemOldVersion.this);
                }
            }
        }
