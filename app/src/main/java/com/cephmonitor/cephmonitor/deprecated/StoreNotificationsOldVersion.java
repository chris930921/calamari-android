 ...
 */
public class StoreNotificationsOldVersion extends SQLiteOpenHelper {
    ...
    public StoreNotificationsOldVersion(Context context) {
    ...
    public ArrayList<NotificationRow> findBeforeData() {
        ...
        cursor.close();
        readOldDataStart += StoreNotificationsOldVersion.FETCH_COUNT;
