...
public class SettingDateFormatsDialog extends SettingDialog {
    ...
    private SettingSingleChoiceItem dateYearMonthDay() {
        SettingSingleChoiceItem v = getChoiceItem(R.string.settings_date_format_dialog_year_month_day);
        v.filedValue.setState(true);
        return v;
    }

    private SettingSingleChoiceItem dateMonthDayYear() {
        return getChoiceItem(R.string.settings_date_format_dialog_month_day_year);
    }

    private SettingSingleChoiceItem dateDayMonthYear() {
        return getChoiceItem(R.string.settings_date_format_dialog_day_month_year);
    }

    private SettingSingleChoiceItem getChoiceItem(int resource) {
        LayoutParams params = new LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
        );
        ...
        v.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SettingSingleChoiceItem v = (SettingSingleChoiceItem) view;
                v.filedValue.setState(true);
            }
        });
