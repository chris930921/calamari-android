...
public class HostHealthItem extends RelativeLayout {
    ...
    public HostHealthItem(Context context) {
        ...
        hostName = hostName();
        rightTextContainer = rightTextContainer(hostName);
    ...
    private TextView hostName() {
        LayoutParams params = new LayoutParams(ruler.getW(51), LayoutParams.WRAP_CONTENT);
    ...
    private RelativeLayout rightTextContainer(View leftView) {
        LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
