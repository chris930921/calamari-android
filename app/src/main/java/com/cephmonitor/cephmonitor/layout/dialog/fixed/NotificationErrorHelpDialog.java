 ...
 */
public class NotificationErrorHelpDialog extends SettingDialog {
    ...
    public NotificationErrorHelpDialog(Context context) {
        super(context);
    ...
    private TextView description() {
        ...
        v.setText(R.string.notification_detail_count_help);
        v.setPadding(
