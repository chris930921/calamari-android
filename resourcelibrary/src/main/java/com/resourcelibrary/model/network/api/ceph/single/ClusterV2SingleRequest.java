 ...
 */
public class ClusterV2SingleRequest extends RequestCephTask {

    public ClusterV2SingleRequest(Context context) {
        super(context);
    }

    @Override
    protected StringRequest taskFlow(final CephParams params, Response.Listener<String> success, Response.ErrorListener fail) {
        String url = CephApiUrl.clusterV2FindOne(params);
    ...
    protected String fakeValue(CephParams params) {
        return "{ \"update_time\": \"2015-04-22T18:41:43.302579+00:00\", \"id\": \"313b8bd3-a506-49bd-ad57-f99cf350505f\", \"name\": \"ceph\" }";
    }
}
