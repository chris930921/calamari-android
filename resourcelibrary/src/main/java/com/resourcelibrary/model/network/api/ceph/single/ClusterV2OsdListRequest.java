...
//        String result = new ReadAssetsFile(getContext()).readText("api/api_v2_cluster_id_osd.txt");
        String result = new ReadAssetsFile(getContext()).readText("api/api_v2_cluster_id_osd_warning_error.txt");
        return result;
    }
}
